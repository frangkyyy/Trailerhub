...
class MoviePaginationPage extends StatefulWidget {
  const MoviePaginationPage({Key? key, required this.type}) : super(key: key);

  final TypeMovie type;

  @override
  _MoviePaginationPageState createState() => _MoviePaginationPageState();
}
        ...
        builderDelegate: PagedChildBuilderDelegate<MovieModel>(
          itemBuilder: (context, item, index) {
            ...
            return ItemMovieWidget(
              movie: item,
              heightBackdrop: 260,
              widthBackdrop: screenWidth, // Gunakan lebar layar
              heightPoster: 140,
              widthPoster: 80,
              onTap: () {
                Navigator.push(
